...
HD_PWD='C:/Users/Metin/Desktop/Blink Leds/Blink_Leds/Blink_Leds.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Blink_Leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Blink_Leds.tcl -notrace
