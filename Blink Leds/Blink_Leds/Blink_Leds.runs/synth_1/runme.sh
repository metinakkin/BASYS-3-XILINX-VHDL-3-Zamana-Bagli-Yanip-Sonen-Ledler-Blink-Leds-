...
HD_PWD='C:/Users/Metin/Desktop/Blink Leds/Blink_Leds/Blink_Leds.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Blink_Leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Blink_Leds.tcl
